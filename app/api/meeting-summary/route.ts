...
- todos は具体的な行動項目のみ抽出
- detailedMinutes はMarkdown形式で記述してください。**見やすさを重視し、大見出し（##）は控えめに、中見出し（###）や小見出し（####）と箇条書き（-）を組み合わせて構造化してください。**
- **重要: detailedMinutes内では太字（**テキスト**）を使用しないでください。強調が必要な場合は、見出しや箇条書きで表現してください。**
- 担当者名が不明な場合は"未定"とする
